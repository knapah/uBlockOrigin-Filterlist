...
- [FMHY Unsafe sites filterlist - Basic](https://raw.githubusercontent.com/fmhy/FMHYFilterlist/main/filterlist-basic.txt) - locks malicious sites listed in the [fmhy unsafe sites page](https://fmhy.net/unsafesites)
